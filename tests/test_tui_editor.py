...
@pytest.fixture
def fake_editors(tmp_path, monkeypatch):
...
def test_resolve_editor_prefers_project_config_over_env(
    fake_editors, monkeypatch: pytest.MonkeyPatch
) -> None:
...
def test_resolve_editor_falls_back_to_first_on_path(fake_editors) -> None:
...
def test_resolve_editor_preserves_args(fake_editors) -> None:
